...
/* Get the values:
   L_tmpnam	How long an array  chars must be to be passed to `tmpnam'.
   TMP_MAX	The minimum number of unique filenames generated by tmpnam
   (and vtmpnam's name space),
...
#if __GLIBC_USE (ISOC2X)* Maximum length of printf output for a NaN.  */
